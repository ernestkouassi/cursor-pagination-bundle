...
/**
 * Handles: lte(value) → field <= value
 *
 * @author Ernest kOUASSI <ernestkouassi02@gmail.com>
 */
class LteFilterExpression extends AbstractFilterExpression
{
    public function evaluate(object $queryBuilder, string $field, mixed $value, string $castType, int &$boundCounter): EvaluationResult
    {
        ...
        $paramName = 'filter_lte_'.$boundCounter++;

        return new EvaluationResult(
            $queryBuilder->expr()->lte($field, ':'.$paramName),
